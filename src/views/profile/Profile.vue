...
<template>
  <q-page class="tw-flex tw-justify-center lg:tw-m-10">
    ...
    >
      ...
      <div class="tw-flex-col lg:tw-flex-row tw-flex tw-gap-y-10 tw-justify-between">
        <div
          class="tw-flex-row tw-flex lg:tw-flex-col tw-items-center lg:tw-items-start tw-gap-3 tw-flex-wrap"
        >
          <profile-item path="/profile/details" name="dane użytkownika" />
          <profile-item path="/profile/address" name="Adres zamieszkania" />
          <profile-item
            path="/profile/address-correspondence"
            name="adres korespondencyjny"
          />
          <profile-item path="/profile/password" name="Hasło" />
        </div>
